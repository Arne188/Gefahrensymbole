...
const focusDetails = {
  schoepfer: {
    title: "Schoepfer Gott",
    text: "Gott gilt als Ursprung der Welt und allen Lebens.",
    points: [
      "Die Welt wird als geschaffen verstanden.",
      "Natur und Leben sind nicht zufaellig.",
      "Menschen tragen Verantwortung fuer die Schoepfung.",
    ],
  },
  allmaechtig: {
    title: "Allmaechtiger Gott",
    text: "Gott wird als maechtig ohne menschliche Grenzen beschrieben.",
    points: [
  ...
  allwissend: {
    ...
    text: "Gott weiss alles ueber Vergangenheit, Gegenwart und Zukunft.",
    points: [
  ...
  beziehung: {
    ...
    points: [
      "Gebet ist eine Form der persoenlichen Beziehung.",
      "Viele glaeubige Menschen suchen Schutz, Trost und Orientierung.",
      "Beziehung bedeutet auch Verantwortung gegenueber anderen Menschen.",
    ],
  },
};

const assignLabels = {
  schoepfer: "Schoepfer Gott",
  allmaechtig: "Allmaechtiger Gott",
...
const assignPool = [
  {
    ...
    answer: "schoepfer",
    explanation: "Das beschreibt Gott als Schoepfer.",
  },
  {
  ...
  {
    statement: "Menschen suchen im Gebet die Naehe Gottes.",
    answer: "beziehung",
  ...
  },
  {
    ...
    answer: "offenbarer",
    explanation: "Schriften gehoeren zur Offenbarungsvorstellung.",
  },
  {
    statement: "Nichts bleibt vor Gott verborgen.",
    answer: "allwissend",
    explanation: "Auch das steht fuer Allwissenheit.",
  },
  {
  ...
  {
    statement: "Die Schoepfung gilt als Geschenk und Auftrag.",
    answer: "schoepfer",
    explanation: "Hier steht die Schoepfungsvorstellung im Zentrum.",
  },
  {
    statement: "Vertrauen und Fuehrung sind zentrale Glaubensmotive.",
    answer: "beziehung",
    explanation: "Das gehoert zur Gottesbeziehung.",
  },
];
...
const commonPool = [
  ...
  },
  {
    ...
    answer: "ja",
    explanation: "Gebet gehoert in allen drei Traditionen zur Praxis.",
  },
  {
    statement: "Alle drei Religionen glauben an viele Goetter.",
    answer: "nein",
    explanation: "Viele Goetter waeren polytheistisch, nicht monotheistisch.",
  },
  {
  ...
  {
    statement: "Zwischen Judentum, Christentum und Islam gibt es ueberhaupt keine Unterschiede.",
    answer: "nein",
...
const quizPool = [
  ...
  {
    prompt: "Welche Vorstellung passt zu 'Schoepfer Gott'?",
    options: [
      "Gott teilt sich nur durch Traeume mit",
      "Gott hat die Welt erschaffen",
      "Gott weiss nichts ueber die Zukunft",
      "Gott ist nur eine Symbolfigur",
    ],
    correct: 1,
    explanation: "Schoepfer Gott bedeutet Ursprung der Welt und des Lebens.",
    wrongReasons: {
      0: "Hier fehlt der Schoepfungsbezug.",
  ...
  },
  {
    ...
    wrongReasons: {
      1: "Schoepfer bezieht sich auf Ursprung der Welt.",
      2: "Polytheismus betrifft viele Goetter.",
  ...
  },
  {
    ...
    options: [
      ...
      "Monotheistische Religionen kennen nur Naturerklaerungen.",
    ...
    wrongReasons: {
      ...
      2: "Es geht um Glaubensbeziehung, nicht nur Naturerklaerung.",
    },
  },
  {
    ...
    wrongReasons: {
      0: "Das waere menschlich begrenzte Macht.",
      2: "Das waere kein allwissender Gott.",
      3: "Offenbarung ist ein wichtiger Grundgedanke.",
    },
  },
  {
    prompt: "Was gehoert zu den heiligen Schriften dieser drei Religionen?",
    options: [
      "Tora, Bibel, Koran",
    ...
    correct: 0,
    explanation: "Diese drei Schriften sind zentral fuer die Traditionen.",
    wrongReasons: {
  ...
  },
  {
    ...
    options: [
      "Gebet und Vertrauen auf Gottes Fuehrung",
      "Ablehnung jeder Form von Glauben",
      "Glaube an viele konkurrierende Goetter",
      "Nur politische Regeln ohne Spiritualitaet",
    ],
    correct: 0,
    explanation: "Gebet und Vertrauen gehoeren zur Beziehungsdimension.",
    wrongReasons: {
      1: "Das beschreibt keine Gottesbeziehung.",
      2: "Das waere polytheistisch.",
  ...
  },
  {
    ...
    options: [
      ...
      "Monotheismus beschreibt den Glauben an viele Goetter.",
    ],
    correct: 1,
    explanation: "Das ist die korrekte Definition.",
    wrongReasons: {
      0: "Die Begriffe meinen Unterschiedliches.",
      2: "Kein Gottesglaube waere Atheismus.",
      3: "Viele Goetter waeren Polytheismus.",
    },
  },
  {
    prompt: "Warum ist die Kategorie 'allwissender Gott' sinnvoll?",
    options: [
      "Sie beschreibt Gottes Wissen ueber alle Zeiten.",
...
function renderAssignRound() {
  ...
  assignTasks.forEach((task, index) => {
    ...
    select.innerHTML = `
      ...
      <option value="schoepfer">${assignLabels.schoepfer}</option>
      <option value="allmaechtig">${assignLabels.allmaechtig}</option>
...
function checkAssignRound() {
  ...
  wmAssignFeedback.innerHTML = `
    <p class="feedback ${correct === assignTasks.length ? "ok" : "bad"}">
      ...
      ${correct === assignTasks.length ? "Sehr gut." : "Arbeite die Rueckmeldungen durch und starte eine neue Runde."}
    </p>
  `;
}
...
function checkCommonRound() {
  ...
  wmCommonFeedback.innerHTML = `
    <p class="feedback ${correct === commonTasks.length ? "ok" : "bad"}">
      ...
      ${correct === commonTasks.length ? "Sehr gut." : "Pruefe die Erklaerungen und starte eine neue Runde."}
    </p>
  `;
}
...
function finishQuiz() {
  ...
  wmQuizFeedback.innerHTML = '<p class="feedback info">Nutze die Fehlererklaerungen zur Wiederholung.</p>';
  wmQuizNext.disabled = true;
