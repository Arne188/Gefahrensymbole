...
const propertyTasks = [
  ...
  {
    id: "p3",
    text: "Mindestens ein Paar gegenüberliegender Seiten ist parallel.",
    answer: "Trapez",
  },
  {
    id: "p4",
  ...
  {
    id: "p6",
    text: "Gegenüberliegende Seiten parallel und gleich lang.",
...
const figures = [
  {
    id: "trapez",
    name: "Trapez",
    description: "Mindestens ein Paar gegenüberliegender Seiten ist parallel.",
    props: {
  ...
  },
  {
    id: "parallelogramm",
    name: "Parallelogramm",
    description: "Zwei Paare gegenüberliegender Seiten sind parallel.",
    props: {
      onePairParallel: true,
...
const maQuizQuestions = [
  {
    ...
    options: [
      ...
      "Es hat zwei Paare gegenüberliegender paralleler Seiten.",
      "Es hat immer genau zwei rechte Winkel.",
    ],
    correct: 2,
    explanation: "Das definierende Merkmal sind zwei Paare paralleler Gegenüberseiten.",
    wrongReasons: {
      ...
      3: "Rechte Winkel gehören nicht zur Definition eines allgemeinen Parallelogramms.",
    },
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Dieses Merkmal gehört zum Drachenviereck.",
    wrongReasons: {
      ...
      3: "Beim Parallelogramm geht es um parallele Gegenüberseiten.",
    },
  },
  {
  ...
  {
    prompt: "Welche Begründung passt fachsprachlich?",
    options: [
    ...
    wrongReasons: {
      0: "Alltagsvergleiche helfen, sind aber keine mathematische Begründung.",
      2: "Farbe ist kein geometrisches Merkmal.",
      3: "Eine Aussage ohne Merkmal ist keine fachliche Begründung.",
    },
  },
];
  ...
  maPropertyFeedback.innerHTML = `
    <p class="feedback ${isAllCorrect ? "ok" : "bad"}">${
      isAllCorrect
        ...
        : `${correct}/${propertyTasks.length} richtig. Prüfe die roten Zeilen noch einmal.`
    }</p>
  `;
}
...
function renderFilterResults() {
  ...
  if (selected.length === 0) {
    maFilterResult.innerHTML = '<p class="feedback info">Wähle mindestens ein Merkmal aus.</p>';
    return;
  }
...
function clearFilter() {
  ...
  maFilterResult.innerHTML = '<p class="feedback info">Wähle Merkmale und klicke auf "Filter anwenden".</p>';
}
...
function finishQuiz() {
  ...
  maQuizFeedback.innerHTML = '<p class="feedback info">Vergleiche falsche Antworten mit den Erklärungen.</p>';
  maQuizNext.disabled = true;
