...
const cycleInfo = {
  achet:
    "Achet (Überschwemmung): Der Nil tritt über die Ufer. Wasser und fruchtbarer Schlamm verteilen sich auf den Feldern. Das schafft die natuerliche Grundlage für spätere Ernten.",
  peret:
    "Peret (Wachstum): Nach dem Rückgang des Wassers werden Felder bestellt, Saat ausgebracht und Kanäle gepflegt. In dieser Phase zeigt sich, wie wichtig Planung und Arbeitsteilung waren.",
  shemu:
    "Shemu (Ernte): Die Ernte wird eingebracht und in Speichern gesichert. Überschuesse unterstuetzen Handel, Versorgung und die Finanzierung staatlicher Aufgaben.",
};
...
const nilePool = [
  {
    ...
    options: [
      { text: "Weil Wasser und fruchtbarer Schlamm Ernten möglich machten.", isCorrect: true, wrongReason: "" },
      { text: "Weil der Fluss nur für Schmuck wichtig war.", isCorrect: false, wrongReason: "Der zentrale Punkt ist Versorgung durch Wasser und Boden." },
      { text: "Weil man den Nil für Siedlungen vermied.", isCorrect: false, wrongReason: "Siedlungen lagen oft bewusst in Nilnaehe." },
      { text: "Weil der Nil Arbeitsteilung unnoetig machte.", isCorrect: false, wrongReason: "Arbeitsteilung blieb für die Gesellschaft wichtig." },
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Fruchtbarer Schlamm blieb auf Feldern zurück.", isCorrect: true, wrongReason: "" },
      { text: "Ackerbau wurde unmöglich.", isCorrect: false, wrongReason: "Die Flut verbesserte die Anbaubedingungen." },
      { text: "Vorratsspeicher wurden nutzlos.", isCorrect: false, wrongReason: "Speicher blieben für schlechte Jahre wichtig." },
      { text: "Handel wurde beendet.", isCorrect: false, wrongReason: "Versorgung und Austausch blieben notwendig." },
    ],
    explanation: "Die Flut erhöhte die Bodenfruchtbarkeit.",
  },
  {
    prompt: "Wozu dienten Vorratsspeicher?",
    options: [
      { text: "Zur Sicherung von Nahrung für spätere Zeiten.", isCorrect: true, wrongReason: "" },
      { text: "Sie ersetzten die Landwirtschaft.", isCorrect: false, wrongReason: "Speicher und Landwirtschaft gehören zusammen." },
      { text: "Sie hatten nur dekorative Aufgaben.", isCorrect: false, wrongReason: "Ihr Zweck war Versorgungssicherheit." },
      { text: "Sie waren nur für Tempel gedacht.", isCorrect: false, wrongReason: "Sie dienten dem Alltag und der Versorgung." },
    ],
    explanation: "Vorrat senkt das Risiko bei schwankenden Ernten.",
  },
  {
    prompt: "Warum war Schrift im Alten Ägypten wichtig?",
    options: [
      { text: "Weil man Verwaltung und Abgaben dokumentieren konnte.", isCorrect: true, wrongReason: "" },
      { text: "Weil Schrift nur als Deko genutzt wurde.", isCorrect: false, wrongReason: "Schrift war ein Werkzeug für Organisation." },
      { text: "Weil Schrift nur private Notizen meinte.", isCorrect: false, wrongReason: "Im Lernmodul geht es vor allem um Verwaltung." },
      { text: "Weil Schrift muendliche Sprache ersetzte.", isCorrect: false, wrongReason: "Schrift ergänzte, ersetzte aber nicht alles." },
    ],
  ...
  },
  {
    ...
    options: [
      { text: "Verschiedene Gruppen übernehmen verschiedene Aufgaben.", isCorrect: true, wrongReason: "" },
      ...
      { text: "Arbeitsteilung gibt es nur heute.", isCorrect: false, wrongReason: "Sie war schon für antike Hochkulturen wichtig." },
    ],
    explanation: "Arbeitsteilung ermöglicht spezialisierte Berufe.",
  },
  {
    prompt: "Welche Aussage beschreibt den Pharao richtig?",
    options: [
      { text: "Er war zentraler Herrscher mit politischer und religiöser Bedeutung.", isCorrect: true, wrongReason: "" },
      { text: "Er war nur ein Dorfvorsteher.", isCorrect: false, wrongReason: "Die Rolle war reichsweit und zentral." },
      { text: "Er war nur ein Händler.", isCorrect: false, wrongReason: "Der Begriff steht für Herrschaft." },
      { text: "Er hatte keine Funktion für den Staat.", isCorrect: false, wrongReason: "Herrschaft und Staat waren eng verbunden." },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Der Fluss wurde für Reisen gemieden.", isCorrect: false, wrongReason: "Transport auf dem Nil war ein Vorteil." },
      { text: "Verkehr spielte im Alten Ägypten keine Rolle.", isCorrect: false, wrongReason: "Verkehr und Handel gehörten zum Alltag." },
      { text: "Der Nil war nur ein religiöses Symbol.", isCorrect: false, wrongReason: "Im Lernteil ist der Alltagsnutzen klar erklärt." },
    ],
    explanation: "Der Nil verband Regionen und förderte Austausch.",
  },
  {
    ...
    options: [
      ...
      { text: "Eine Gesellschaft ohne Verwaltung.", isCorrect: false, wrongReason: "Verwaltung gehört dazu." },
    ],
...
const culturePool = [
  ...
  { statement: "Vorrat und Planung spielen für Versorgung eine Rolle.", correct: "merkmal", explanation: "Vorratsspeicher sichern Ernten." },
  { statement: "Siedlungen haben nichts mit Umweltbedingungen zu tun.", correct: "kein", explanation: "Im Modul wird die Nilnaehe klar erklärt." },
  { statement: "Schreiber halten wichtige Daten schriftlich fest.", correct: "merkmal", explanation: "Das wurde bei Begriffen und Aufgaben erklärt." },
...
const causeEffectPool = [
  {
    cause: "Der Nil überschwemmt regelmaessig die Ufer.",
    effect: "Fruchtbarer Schlamm verbessert die Felder.",
    explanation: "So entsteht die Basis für gute Ernten.",
  },
  {
    cause: "Es gibt regelmäßige Ernten und Vorrat.",
    effect: "Die Versorgung wird stabiler.",
    explanation: "Vorrat puffert schlechte Zeiten ab.",
  },
  {
    cause: "Es entstehen Ernteüberschuesse.",
    effect: "Arbeitsteilung mit verschiedenen Berufen wird möglich.",
  ...
  },
  {
    ...
    effect: "Größere Projekte können koordiniert werden.",
    explanation: "Organisation macht langfristige Planung möglich.",
  },
  {
    cause: "Ackerflächen liegen besonders am Nil.",
    effect: "Siedlungen konzentrieren sich in Flussnaehe.",
    explanation: "Menschen siedeln dort, wo Versorgung möglich ist.",
  },
];
    ...
    },
    {
      ...
      wrongReason:
        item.correct === "merkmal"
          ? `Diese Aussage gehört zu den Kernmerkmalen. ${item.explanation}`
          : "",
    },
  ];
  return {
...
function checkChoiceRound(target, tasks, prefix, summaryTarget, missingMessage) {
    ...
    if (selected?.isCorrect) {
      ...
      feedback.innerHTML = `
        <p class="feedback bad">
          ...
          Richtige Lösung: "${correctOption?.text || ""}". ${tasks[index].explanation}
        </p>
      `;
    }
  });
  ...
  summaryTarget.innerHTML = `
    <p class="feedback ${allCorrect ? "ok" : "bad"}">
      ...
      ${allCorrect ? "Sehr gut. Du kannst in den Test wechseln." : "Arbeite die roten Erklärungen durch und starte eine neue Runde."}
    </p>
  `;
}
...
function fixedQuizQuestions() {
  return [
    {
      prompt: "Was erklärt den Titel 'Geschenk des Nils' am besten?",
      options: [
        "Wasser und Bodenfruchtbarkeit machten Versorgung möglich.",
        "Der Nil war nur ein religiöses Symbol.",
      ...
      wrongReasons: {
        ...
        3: "Die Bedeutung ist gerade für die Antike zentral.",
      },
    },
    {
      ...
      correct: 1,
      explanation: "Schrift und Verwaltung gehören zu den Kernmerkmalen.",
      wrongReasons: {
    ...
    },
    {
      ...
      options: [
        ...
        "Sie waren nur für Unterhaltung da.",
      ...
      wrongReasons: {
        ...
        3: "Schrift wurde auch im Alltagsbetrieb benötigt.",
      },
    },
  ];
}
...
function finishQuiz() {
  ...
  hiQuizPrompt.textContent = "Starte neu für weitere Aufgaben aus dem Pool.";
  hiQuizAnswers.innerHTML = "";
  hiQuizFeedback.innerHTML = '<p class="feedback info">Nutze die Fehlererklaerungen für deine Wiederholung.</p>';
  hiQuizNext.disabled = true;
...
function submitQuizAnswer(optionIndex) {
  ...
  const wrongReason = question.wrongReasons?.[optionIndex] || "Prüfe Ursache-Folge und Hochkultur-Merkmale erneut.";
  hiQuizFeedback.innerHTML = `
  ...
  hiQuizNext.textContent =
    hiQuizState.index === hiQuizState.questions.length - 1 ? "Ergebnis anzeigen" : "Nächste Frage";
}
