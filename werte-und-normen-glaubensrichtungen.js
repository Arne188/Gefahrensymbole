...
const typeDetails = {
  poly: {
    title: "Polytheismus",
    text: "Polytheismus bedeutet: Es gibt mehrere Goetter. Diese Goetter haben oft unterschiedliche Aufgaben oder Zustaendigkeitsbereiche.",
    points: [
      "Beispiele: altgriechische, altaegyptische und roemische Religionen.",
      "Im Unterricht wird oft auch der Hinduismus als Beispiel genannt (vereinfacht).",
      "Merksatz: Viele Goetter, viele Rollen.",
    ],
  },
  mono: {
    title: "Monotheismus",
  ...
  athe: {
    title: "Atheismus",
    text: "Atheismus bedeutet: Es wird nicht an einen Gott oder mehrere Goetter geglaubt.",
    points: [
      "Atheismus ist eine Weltanschauung, keine Religion.",
      "Erklaerungen werden haeufig ohne Gottesbezug gesucht.",
...
const assignPool = [
  ...
  },
  {
    ...
    answer: "poly",
    explanation: "Es gibt viele Goetter mit unterschiedlichen Aufgaben.",
  },
  {
    label: "Altaegyptische Religion",
    answer: "poly",
    explanation: "Auch hier werden viele Goetter verehrt.",
  },
  {
    label: "Hinduismus",
    answer: "poly",
  ...
  },
  {
    label: "Atheismus",
    answer: "athe",
    explanation: "Kein Glaube an Gott oder Goetter.",
  },
  {
    label: "Buddhismus",
    answer: "off",
  ...
  {
    label: "Glaube an einen einzigen Schoepfergott",
    answer: "mono",
...
const statementPool = [
  {
    prompt: "Es gibt viele Goetter mit unterschiedlichen Bereichen.",
    answer: "poly",
  ...
  {
    prompt: "Judentum, Christentum und Islam gehoeren meist in dieselbe Kategorie.",
    answer: "mono",
    explanation: "Alle drei werden im Unterricht als monotheistisch eingeordnet.",
  },
  {
    prompt: "Wenn mehrere Goetter vorkommen, passt meistens diese Kategorie.",
    answer: "poly",
    explanation: "Viele Goetter -> Polytheismus.",
  },
  {
    prompt: "Kein Gottesglaube, oft naturwissenschaftliche Erklaerungen.",
    answer: "athe",
...
const quizPool = [
  {
    ...
    wrongReasons: {
      0: "Das ist ein haeufiger Schreibfehler.",
  ...
  },
  {
    ...
    options: [
      "Glaube an mehrere Goetter",
      "Kein Gottesglaube",
      "Glaube an einen einzigen Gott",
      "Nur Naturerklaerungen ohne Glauben",
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Islam", "Altgriechische Religion", "Altaegyptische Religion", "Roemische Mythologie"],
    correct: 0,
    explanation: "Der Islam ist monotheistisch.",
    wrongReasons: {
      1: "Hier gibt es mehrere Goetter.",
      2: "Hier gibt es mehrere Goetter.",
      3: "Mythologische Goetterwelt ist polytheistisch.",
    },
  },
  {
    ...
    options: [
      ...
      "Kein Glaube an Goetter",
      "Glaube an nur antike Goetter",
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      "Atheismus ist eine Religion mit vielen Goettern.",
    ...
    wrongReasons: {
      ...
      1: "Polytheismus bedeutet viele Goetter.",
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Die altgriechische Religion kennt viele Goetter.",
    wrongReasons: {
  ...
  },
  {
    ...
    correct: 1,
    explanation: "Einige Traditionen sind vielfaeltig und nicht mit einem Wort erklaert.",
    wrongReasons: {
      0: "Religionen und Weltanschauungen unterscheiden sich.",
      2: "Kategorien helfen, wenn man ihre Grenzen kennt.",
      3: "Die Begriffe sind vorhanden und nuetzlich.",
    },
  },
  {
    ...
    options: [
      ...
      "Kein Glaube an Goetter",
      "Viele Goetter mit unterschiedlichen Rollen",
      "Nur wissenschaftliche Erklaerungen",
    ],
    correct: 2,
    explanation: "Viele Goetter mit Rollen ist die Kernidee.",
    wrongReasons: {
  ...
  },
  {
    ...
    options: [
      ...
      "Einfache Kategorien helfen beim Start, aber manche Faelle bleiben offen.",
      "Nur Atheismus ist eine Religion.",
      "Monotheismus bedeutet viele Goetter.",
    ],
    correct: 1,
    explanation: "So lernst du klar und bleibst trotzdem fachlich fair.",
    wrongReasons: {
      0: "Zuordnungen sind hilfreich, aber nicht immer vollstaendig.",
  ...
  },
  {
    ...
    options: [
      ...
      "Altaegyptische Religion - monotheistisch",
    ...
    wrongReasons: {
      ...
      2: "Altaegyptische Religion ist polytheistisch.",
...
function checkAssignRound() {
  ...
  wnAssignFeedback.innerHTML = `
    <p class="feedback ${correct === assignTasks.length ? "ok" : "bad"}">
      ...
      ${correct === assignTasks.length ? "Sehr gut." : "Lies die roten Rueckmeldungen und starte danach eine neue Runde."}
    </p>
  `;
}
...
function checkStatementRound() {
  ...
  rows.forEach((row, index) => {
    ...
    feedback.innerHTML = `
      <p class="feedback bad">
        Noch nicht passend. Richtige Loesung: ${categoryLabels[task.answer]}.
        ${task.explanation}
      </p>
    `;
  });
  ...
  wnStatementFeedback.innerHTML = `
    <p class="feedback ${correct === statementTasks.length ? "ok" : "bad"}">
      ...
      ${correct === statementTasks.length ? "Sehr gut." : "Arbeite die Rueckmeldungen durch und starte eine neue Runde."}
    </p>
  `;
}
...
function finishQuiz() {
  ...
  wnQuizFeedback.innerHTML = '<p class="feedback info">Nutze die Fehlererklaerungen fuer die Wiederholung.</p>';
  wnQuizNext.disabled = true;
